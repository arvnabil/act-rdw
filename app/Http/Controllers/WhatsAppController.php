...
class WhatsAppController extends Controller
{
    public function redirect(Request $request)
    {
        ...
        $existingEvent = \Modules\Core\Models\AnalyticsClickEvent::where('ip_address', $request->ip())
        ...
        if ($existingEvent && !$isBot) {
            ...
            $event = \Modules\Core\Models\AnalyticsClickEvent::create([
            ...
            if (!$isBot) {
                \App\Jobs\ResolveGeoLocation::dispatch($event);
            }
        }
