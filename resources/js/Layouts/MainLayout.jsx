    ...
    return (
        <>
            <div className="slider-drag-cursor d-flex align-items-center justify-content-between">
                <span className="drag-icon-left"><img src="/assets/img/icon/drag-arrow-left.svg" alt="" /></span>
                DRAG
                    ...
                    <div className="widget">
                        <div className="th-widget-about">
                            <div className="about-logo">
                                <Link href="/"><img src="/assets/img/logo2.svg" alt="Atek" /></Link>
                            </div>
                        ...
                        <div className="recent-post-wrap">
                            <div className="recent-post d-flex align-items-center">
                                <div className="media-img">
                                    <Link href="/blog"><img src="/assets/img/blog/recent-post-1-1.jpg" alt="Blog Image" /></Link>
                                </div>
                                <div className="media-body">
                                    <div className="recent-post-meta">
                                        <Link href="/blog"><i className="far fa-calendar"></i>24 Jun , 2025</Link>
                                    </div>
                                    <h4 className="post-title">
                                        <Link className="text-inherit" href="/blog">Where Vision Meets Concrete Reality</Link>
                                    </h4>
                                </div>
                            </div>
                            <div className="recent-post d-flex align-items-center">
                                <div className="media-img">
                                    <Link href="/blog"><img src="/assets/img/blog/recent-post-1-2.jpg" alt="Blog Image" /></Link>
                                </div>
                                <div className="media-body">
                                    <div className="recent-post-meta">
                                        <Link href="/blog"><i className="far fa-calendar"></i>22 Jun , 2025</Link>
                                    </div>
                                    <h4 className="post-title">
                                        <Link className="text-inherit" href="/blog">Raising the Bar in Construction.</Link>
                                    </h4>
                                </div>
                            </div>
                        </div>
            ...
            <div className="th-menu-wrapper onepage-nav">
                <div className="th-menu-area text-center">
                    ...
                    <div className="th-mobile-menu allow-natural-scroll">
                        <div className="mobile-search-box position-relative mb-4" style={{ padding: '0 20px' }}>
                            <form action="#">
                                <input type="text" placeholder="Search..." className="form-control" style={{ height: '50px', paddingRight: '50px', borderRadius: '5px' }} />
                                <button type="submit" style={{ position: 'absolute', right: '35px', top: '50%', transform: 'translateY(-50%)', border: 'none', background: 'none', color: 'var(--theme-color)' }}>
                        ...
                        <ul>
                            ...
                            <li className="menu-item-has-children">
                                ...
                                <ul className="sub-menu">
                                    <li><a href="https://accommerce.id" target="_blank">Shop</a></li>
                        ...
                        <div className="mobile-header-info mt-30 text-center">
                            <div className="currency-menu mb-3 d-inline-flex align-items-center" style={{ border: '1px solid var(--light-color)', borderRadius: '100px', padding: '8px 20px', margin: '0 auto', gap: '8px' }}>
                                <i className="fa-light fa-earth-africa"></i>
                                <select className="form-select nice-select" defaultValue="English" style={{ border: 'none', background: 'transparent', padding: 0, margin: 0, height: 'auto', lineHeight: 'inherit', width: 'auto' }}>
                            ...
                            <div className="text-center mt-3">
                                <Link href="/contact" className="th-btn th-radius th-icon">
                                ...
                                <div className="header-links">
                                    <ul>
                                        <li className="d-none d-xl-inline-block">
                                            ...
                                            <span><a href="https://www.instagram.com/activ_teknologi/" target="__BLANK">@activ_teknologi</a></span>
                                        </li>
                                        <li className="d-none d-xl-inline-block">
                                            <i className="fa-regular fa-clock"></i>
                                            <span>Sun to Friday: 8.30 am - 05.30 pm</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div className="col-auto d-none d-xl-block">
                                <div className="header-right">
                                    <div className="currency-menu">
                                        <i className="fa-light fa-earth-africa"></i>
                                        <select className="form-select nice-select" defaultValue="English">
                                            <option>English</option>
                                            <option>Indonesian</option>
                                        </select>
                                    </div>
                            ...
                            <div className="row align-items-center justify-content-between">
                                ...
                                <div className="col-xl-2 col-xxl-3 col-auto d-none d-lg-block">
                                    <div className="header-button">
                                        ...
                                        <Link href="/contact" className="th-btn th-radius th-icon d-none d-xxl-block">
                                            Get In Touch <i className="fa-light fa-arrow-right-long"></i>
                                        </Link>
                                    </div>
                                </div>
                        ...
                        <div className="row justify-content-between">
                            <div className="col-md-6 col-xl-3">
                                <div className="widget footer-widget">
                                    <div className="th-widget-about">
                                        <div className="about-logo">
                                            <Link href="/"><img src="/assets/img/logo3.svg" alt="Atek" /></Link>
                                        </div>
                                        <p className="about-text">
                                            we are dedicated to delivering the best comprehensive
                                ...
                                <div className="widget widget_nav_menu footer-widget">
                                    ...
                                    <div className="menu-all-pages-container">
                                        <ul className="menu">
                                            ...
                                            <li><Link href="/about" style={{ color: '#fff' }}>About us</Link></li>
                                            <li><Link href="/services" style={{ color: '#fff' }}>Our Service</Link></li>
                                            <li><Link href="/contact" style={{ color: '#fff' }}>Terms of Service</Link></li>
                                            <li><Link href="/news" style={{ color: '#fff' }}>News & Media</Link></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="widget footer-widget">
                                    ...
                                    <div className="th-widget-contact">
                                        <div className="info-box_text">
                                            ...
                                            <div className="details">
                                                <p><a style={{ color: '#fff' }} href="tel:+622150110987" className="info-box_link">Tel: (+62) 2150110987</a></p>
                                                <p><a style={{ color: '#fff' }} href="https://api.whatsapp.com/send?phone=6285162994602" className="info-box_link">WA: (+62) 851-6299-4602</a></p>
                                            </div>
                                        </div>
                                        <div className="info-box_text">
                                            <div className="icon">
                                            ...
                                            <div className="details">
                                                <p><a style={{ color: '#fff' }} href="mailto:info@activ.co.id" className="info-box_link">info@activ.co.id</a></p>
                                                <p><a style={{ color: '#fff' }} href="mailto:sales@activ.co.id" className="info-box_link">sales@activ.co.id</a></p>
                                            </div>
                                        </div>
                                        <div className="info-box_text">
                                            <div className="icon">
                                            ...
                                            <div className="details">
                                                <p><a style={{ color: '#fff' }} href="https://maps.app.goo.gl/td2c6mkExW9zmY7C8" target="_blank">Infinity Office, Belleza BSA 1st Floor Unit 106, Jl. Letjen Soepeno, Keb. Lama Jakarta Selatan 12210</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="col-md-6 col-xl-auto">
                                <div className="widget footer-widget footer-newsletter-style3">
                                    <h4 className="widget_title">Get updated the latest newsletter</h4>
                                    <div className="newsletter-widget">
                                        <div className="footer-search-contact">
                                            <h4 className="newsletter-title">Email Address</h4>
                                            <form action="#">
                                                <input className="form-control" type="email" placeholder="Enter your email address...." />
                                                <button type="submit" className="icon-btn style2">
                        ...
                        <div className="row justify-content-between align-items-center">
                            <div className="col-lg-6">
                                <p className="copyright-text">
                                    Copyright © 2025 <Link href="/">ACTiV</Link>. All rights reserved.
                                </p>
                            </div>
                            <div className="col-lg-6 text-lg-end text-center">
                                <div className="footer-links">
                                    <ul>
                                        ...
                                        <li><Link href="/contact">Partner Us</Link></li>
                ...
                <div className="tab-content" id="pills-tabContent">
                    <div className="tab-pane fade" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                        ...
                        <div className="th-login-form">
                            <form action="#" method="POST" className="login-form ajax-contact">
                                <div className="row">
                                    <div className="form-group col-12">
                                        <label>Username or email</label>
                                        <input type="text" className="form-control" name="email" id="login_email" required />
                                    </div>
                                    <div className="form-group col-12">
                                        <label>Password</label>
                                        <input type="password" className="form-control" name="pasword" id="pasword" required />
                                    </div>
                                ...
                                <div id="forgot_url">
                                    <Link href="/my-account">Forgot password?</Link>
                                </div>
                        ...
                        <form action="#" method="POST" className="login-form ajax-contact">
                            <div className="row">
                                <div className="form-group col-12">
                                    ...
                                    <input type="text" className="form-control" name="usename" id="usename" required />
                                </div>
                                <div className="form-group col-12">
                                ...
                                <div className="form-group col-12">
                                    ...
                                    <input type="text" className="form-control" name="new_email" id="new_email" required />
                                </div>
                                <div className="form-group col-12">
                                    <label htmlFor="new_email_confirm">Confirm email*</label>
                                    <input type="text" className="form-control" name="new_email_confirm" id="new_email_confirm" required />
                                </div>
