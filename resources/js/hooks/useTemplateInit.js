...
export function useTemplateInit() {
    ...
    useEffect(() => {
        ...
        $.fn.thmobilemenu = function (options) {
            ...
            return this.each(function () {
                ...
                menu.find("." + opt.subMenuParent).each(function () {
                    ...
                    if ($(this).children("a").find(".th-mean-expand").length === 0) {
                ...
                $(document).off("click", opt.menuToggleBtn).on("click", opt.menuToggleBtn, function () {
                    menuToggle();
                });
                ...
                menu.find("div").off("click").on("click", function (e) {
                    if ($(e.target).closest(".th-menu-toggle").length === 0) {
                        e.stopPropagation();
                    }
                });
            });
            ...
            new Swiper('.hero-slider-2', {
                ...
                on: {
                    slideChangeTransitionStart: function () {
                        ...
                        $(this.slides).find('[data-ani]').each(function () {
                    ...
                    slideChangeTransitionEnd: function () {
                        ...
                        $(this.slides[this.activeIndex]).find('[data-ani]').each(function () {
                            var ani = $(this).data('ani');
                            $(this).addClass(ani);
                        });
                    }
        ...
        // --- Magnific Popup ---
        import('magnific-popup/dist/jquery.magnific-popup.js').then(() => {
            $('.popup-video').magnificPopup({ type: 'iframe' });
            $('.popup-image').magnificPopup({ type: 'image', gallery: { enabled: true } });
            $('.popup-login-register').magnificPopup({ type: 'inline', fixedContentPos: false, focus: '#name' });
