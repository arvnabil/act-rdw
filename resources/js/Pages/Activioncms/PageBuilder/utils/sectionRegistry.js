import SliderSection from "@/Components/Sections/Builder/SliderSection";
import AboutSection from "@/Components/Sections/Builder/AboutSection";
import BrandSection from "@/Components/Sections/Builder/BrandSection";
import ServiceSection from "@/Components/Sections/Builder/ServiceSection";
import WhyChooseUsSection from "@/Components/Sections/Builder/WhyChooseUsSection";
import ProjectSection from "@/Components/Sections/Builder/ProjectSection";
import ClientSection from "@/Components/Sections/Builder/ClientSection";
import NewsSection from "@/Components/Sections/Builder/NewsSection";
...
export const sectionRegistry = {
    // 10. Partner List (Full with Categories)
    partner_list: {
        id: "partner_list",
        label: "Partner List (Full with Categories)",
        icon: "fa-regular fa-handshake",
        component: PartnerListSection,
        schema: [
    ...
    slider: {
        ...
        schema: [
            ...
            // Hero Config
            { name: "delay", type: "text", label: "Autoplay Delay (ms)" },
            {
                name: "slides",
                type: "repeater",
                label: "Slides (Hero)",
            ...
            // Brand Config
            { name: "title", type: "text", label: "Title (Brand Only)" },
            { name: "subtitle", type: "text", label: "Subtitle (Brand Only)" },
            {
                name: "brands",
                type: "repeater",
                label: "Brands (Manual)",
                schema: [
                    { name: "image", type: "image", label: "Logo URL" },
                    { name: "name", type: "text", label: "Alt Text" },
                ],
            },
        ],
        defaultConfig: {
            ...
            brands: [], // Manual brands if needed
        },
    },
        ...
        schema: [
            ...
            // Features Repeater
            {
                ...
                schema: [
                    ...
                    { name: "text", type: "textarea", label: "Feature Text" },
                    { name: "icon", type: "image", label: "Icon URL" },
                ],
            },
            // Images Repeater
            {
                name: "images",
                type: "repeater",
                label: "Images (Top 3 used)",
                schema: [{ name: "url", type: "image", label: "Image URL" }],
            },
        ],
        defaultConfig: {
            show_button: true,
            ...
            subtitle: "Who We Are",
            description:
                "ACTiV (PT Alfa Cipta Teknologi Virtual) is a dynamic company...",
            images: [],
            features: [
                {
                    title: "ICT & Education Product Supply",
                    text: "Official provider...",
    ...
    services: {
        ...
        schema: [
            ...
            { name: "limit", type: "text", label: "Limit (max items)" },
            {
                name: "order",
                type: "select",
                label: "Order By",
    ...
    // 6. Clients / Partners (Hybrid)
    // 6. Brand Partners (Query Only)
    brand_partners: {
        id: "brand_partners",
        label: "Brand Partners",
        icon: "fa-regular fa-handshake",
        component: BrandSection, // Ensure import
        schema: [
            { name: "title", type: "text", label: "Title" },
            { name: "subtitle", type: "text", label: "Subtitle" },
            { name: "limit", type: "text", label: "Limit" },
    ...
    // 8. CTA Clients (Hybrid)
    cta_clients: {
        id: "cta_clients",
        label: "Clients Showcase (Home)",
        ...
        schema: [
            ...
            { name: "cta_text", type: "text", label: "CTA Text" },
            { name: "cta_url", type: "text", label: "CTA URL" },
            // Hybrid: allow manual override if needed? User example didn't show it but typical Hybrid has it.
            // User said "source: clients" implying strict query?
            // "cta_clients (hybrid)" implies mix.
    ...
    // Legacy Support: CTA -> ClientSection
    cta: {
        id: "cta",
        label: "CTA (Clients) [Legacy]",
        icon: "fa-regular fa-star",
        component: ClientSection,
        schema: [
            { name: "title", type: "text", label: "Title" },
    ...
    // --- LEGACY ABOUT SECTIONS (Read Only) ---
    // --- LEGACY ABOUT SECTIONS (Editable) ---
    about_content: {
        id: "about_content",
        label: "About Content (Legacy)",
        ...
        schema: [
            ...
            { name: "video_url", type: "text", label: "Video URL" },
            {
                name: "images",
                type: "repeater",
                label: "Images (Top 2 used)",
                schema: [{ name: "image", type: "image", label: "Image URL" }],
            },
            {
                name: "features",
                type: "repeater",
        ...
        defaultConfig: {
            ...
            title: "Bridging Technology and Education for a Better Future.",
            description:
                "ACTiV (PT Alfa Cipta Teknologi Virtual) is a premier provider of ICT and Educational solutions, specializing in hardware, software, and accessory rentals and sales. With over six years of industry experience and strategic partnerships with multinational brands, we deliver comprehensive, tailored technology solutions to empower our clients' success.",
            video_url: "https://www.youtube.com/watch?v=hIIQbkkKnno",
            images: [
                { image: "/assets/img/normal/about_2_1.jpg" },
                { image: "/assets/img/normal/about_2_2.jpg" },
            ],
            features: [
                {
                    title: "Expert Team",
                    description:
                        "Our team consists of seasoned professionals with deep expertise in ICT and education sectors.",
                    icon: "/assets/img/icon/guide.svg",
                },
                {
                    title: "Certified Partnerships",
                    description:
                        "We hold official partnerships with leading global brands, ensuring authentic products and certified technical support.",
                    icon: "/assets/img/icon/policy.svg",
                },
                {
                    title: "Dedicated Support",
                    description:
                        "Our responsive support system operates across multiple channels to provide timely resolutions and ensure business continuity.",
    ...
    vision_mission: {
        ...
        schema: [
            ...
            { name: "mission_title", type: "text", label: "Mission Title" },
            {
                ...
                label: "Mission Items",
                schema: [
                    { name: "text", type: "textarea", label: "Mission Point" },
                ],
            },
            { name: "goal_title", type: "text", label: "Goal Title" },
            { name: "goal_text", type: "textarea", label: "Goal Text" },
        ],
        defaultConfig: {
            vision_title: "Our Vision",
            vision_text:
                "To be Indonesia's leading national provider of ICT and Education solutions, recognized for excellence in service, sales, and rentals.",
            ...
            goal_title: "Our Goal",
            goal_text:
                "To become a trusted partner delivering consultative ICT solutions that drive productivity and resolve complex business challenges efficiently.",
        },
    },
    testimonial: {
        id: "testimonial",
        ...
        schema: [
            ...
            { name: "title", type: "text", label: "Title" },
            {
                ...
                schema: [
                    ...
                    { name: "image", type: "image", label: "Avatar" },
            ...
            testimonials: [
                {
                    name: "Sarah Rahman",
                    role: "UI/UX Designer",
                    quote: "Cybersecurity is more critical than ever, and this team gave us peace of mind. Their vulnerability assessments were thorough, and the security roadmap they designed was easy to implement. Highly professional and knowledgeable!",
                    rating: 5,
                ...
                },
                {
                    ...
                    quote: "We needed a complete overhaul of our IT infrastructure, and the results exceeded our expectations. The new system is faster, more secure, and has significantly improved our workflow efficiency. Truly a top-tier service provider.",
                    rating: 5,
                ...
                },
                {
                    ...
                    quote: "Managing software licenses across multiple departments was a nightmare until we partnered with them. Their rental solutions are flexible, cost-effective, and the support team is always just a call away.",
                    rating: 5,
                ...
                },
                {
                    name: "Budi Pratama",
                    role: "CTO, TechCorp",
                    quote: "The consultation services provided were invaluable. They helped us identify bottlenecks in our business processes and implemented ICT solutions that boosted our productivity by 40%.",
                    rating: 5,
    ...
    contact: {
        ...
        schema: [
            ...
            { name: "address_office", type: "textarea", label: "Main Office" },
            {
                name: "address_representative",
                type: "textarea",
            ...
            },
            {
                ...
                schema: [
                    ...
                    },
                    {
                        name: "required",
                        type: "text",
                        label: "Is Required? (true/false)",
                    },
                    {
                        name: "icon",
                        type: "image",
                        label: "Field Icon (Optional)",
                    },
                    {
                        name: "width",
                        type: "select",
                        label: "Width",
                        options: [
                            { label: "Half Width (50%)", value: "col-sm-6" },
                            { label: "Full Width (100%)", value: "col-12" },
                        ],
                    },
                ],
            },
        ...
        defaultConfig: {
            ...
            intro_text:
                "We appreciate your interest in ACTiV. Our team is ready to discuss how we can support your business goals. Please contact us via the channels below.",
            phone: "(+62) 2150110987",
            whatsapp: "(+62) 851-6299-4602",
            email: "sales@activ.co.id",
            address_office:
                "Infinity Office, Belleza BSA 1st Floor Unit 106, Jl. Letjen Soepeno, Keb. Lama Jakarta Selatan 12210",
            address_representative:
                "Ruko Golden Boulevard Blok S 28, Jl Pahlawan Seribu, BSD City, Kec. , Tangerang, 15119, Kota Tangerang Selatan, Banten 15119",
            map_embed_url:
                "https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d9894.100972827648!2d106.66287000000001!3d-6.276524!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69fb227ca11a57%3A0x1d99e2c09955d44d!2sPT%20Alfa%20Cipta%20Teknologi%20Virtual%20(ACTiV)!5e1!3m2!1sid!2sid!4v1765353648986!5m2!1sid!2sid",
