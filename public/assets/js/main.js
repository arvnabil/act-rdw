(function ($) {
    ...
    */
    ...
    document.querySelectorAll(".scroll-text-ani2").forEach((line) => {
        gsap.to(line, {
    ...
    /* Card Animation Like Chain */
    if (window.matchMedia("(min-width: 991px)").matches) {
        document.querySelectorAll(".card-animation-chain").forEach((card, index) => {
            const rotateValue = index % 2 === 0 ? -15 : 15;
            const translateX = index % 2 === 0 ? -100 : 100;
            const translateY = -100; // Same in both cases
