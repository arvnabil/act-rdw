...
namespace Modules\Analytics\Filament\Resources\WhatsAppAnalyticsResource\Tables;
        ...
        return $table
            ...
            ->filters([
                Tables\Filters\SelectFilter::make('utm_source')
                    ->options(fn () => \Modules\Analytics\Models\AnalyticsClickEvent::query()->where('event_type', 'whatsapp')->distinct()->pluck('utm_source', 'utm_source')->filter()->toArray()),
                Tables\Filters\SelectFilter::make('utm_medium')
                    ->options(fn () => \Modules\Analytics\Models\AnalyticsClickEvent::query()->where('event_type', 'whatsapp')->distinct()->pluck('utm_medium', 'utm_medium')->filter()->toArray()),
                Tables\Filters\SelectFilter::make('utm_campaign')
                    ->options(fn () => \Modules\Analytics\Models\AnalyticsClickEvent::query()->where('event_type', 'whatsapp')->distinct()->pluck('utm_campaign', 'utm_campaign')->filter()->toArray()),
                Tables\Filters\SelectFilter::make('utm_content')
                    ->options(fn () => \Modules\Analytics\Models\AnalyticsClickEvent::query()->where('event_type', 'whatsapp')->distinct()->pluck('utm_content', 'utm_content')->filter()->toArray()),
                Tables\Filters\SelectFilter::make('cta_position')
                    ->options(fn () => \Modules\Analytics\Models\AnalyticsClickEvent::query()->where('event_type', 'whatsapp')->distinct()->pluck('cta_position', 'cta_position')->filter()->toArray()),
                ...
                Tables\Filters\SelectFilter::make('city')
                    ->options(fn () => \Modules\Analytics\Models\AnalyticsClickEvent::query()->where('event_type', 'whatsapp')->whereNotNull('city')->distinct()->pluck('city', 'city')->toArray()),
