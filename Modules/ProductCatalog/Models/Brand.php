...
class Brand extends Model
{
    ...
    {
        return $this->belongsToMany(\Modules\Services\Models\ServiceSolution::class, 'service_solution_brand');
    }
    ...
    public function getLandingConfigAttribute($value)
    {
        ...
        if (isset($decoded['cta_url']) && is_string($decoded['cta_url'])) {
            $decoded['cta_url_rel'] = \Modules\SEO\Helpers\SeoHelper::get_rel($decoded['cta_url']);
        }
