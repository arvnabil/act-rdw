...
class ServiceSolutionRelationManager extends RelationManager
{
                        ...
                        Tab::make('SEO')
                            ->schema([
                                \Filament\Schemas\Components\Group::make()
                                    ->relationship('seo')
                                    ->schema(\Modules\SEO\Filament\Resources\SeoMetaResource\Schemas\SeoForm::schema())
                            ]),
                        Tab::make('Breadcrumb')
                            ->schema(\Modules\CMS\Filament\Schemas\BreadcrumbForm::schema('services/solutions')),
                    ])->columnSpanFull(),
            ]);
    }
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->headerActions([
                \Filament\Actions\ExportAction::make('export_service_solutions')
                    ->exporter(\Modules\Services\Filament\Exports\ServiceSolutionExporter::class),
                \Filament\Actions\ImportAction::make('import_service_solutions')
                    ->importer(\Modules\Services\Filament\Imports\ServiceSolutionImporter::class)
