...
class ServiceCategoryRelationManager extends RelationManager
{
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->headerActions([
                \Filament\Actions\ExportAction::make('export_service_categories')
                    ->exporter(\Modules\Services\Filament\Exports\ServiceCategoryExporter::class),
                \Filament\Actions\ImportAction::make('import_service_categories')
                    ->importer(\Modules\Services\Filament\Imports\ServiceCategoryImporter::class)
