...
class ProductConfiguratorSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // Ensure Brands exist
        $brandLogi = \Modules\ProductCatalog\Models\Brand::firstOrCreate(['slug' => 'logitech'], ['name' => 'Logitech']);
        $brandYealink = \Modules\ProductCatalog\Models\Brand::firstOrCreate(['slug' => 'yealink'], ['name' => 'Yealink']);
        $brandJabra = \Modules\ProductCatalog\Models\Brand::firstOrCreate(['slug' => 'jabra'], ['name' => 'Jabra']);

        // Ensure Service exists
        $svcVC = \Modules\Services\Models\Service::firstOrCreate(
        ...
        $prodMeetUp2 = \Modules\ProductCatalog\Models\Product::where('slug', 'meetup-2-prod')->first();
        if ($prodMeetUp2) {
            $optMeetUp2->products()->attach($prodMeetUp2->id);
        }

        // Create Accessory Products first
        $prodTVMount = \Modules\ProductCatalog\Models\Product::updateOrCreate(
        ...
        $prodWallMount = \Modules\ProductCatalog\Models\Product::updateOrCreate(
        ...
        $prodRallyBarMini = \Modules\ProductCatalog\Models\Product::updateOrCreate(
        ...
        $prodBCC950 = \Modules\ProductCatalog\Models\Product::updateOrCreate(
            ['slug' => 'bcc950-prod'],
            [
        ...
        $prodConnect = \Modules\ProductCatalog\Models\Product::updateOrCreate(
            ['slug' => 'connect-prod'],
            [
        ...
        $prodRallyBar = \Modules\ProductCatalog\Models\Product::updateOrCreate(
            ['slug' => 'rally-bar-prod'],
            [
        ...
        $optGroup = $qDevice->options()->create([
            ...
            'metadata' => [
                ...
                'accessories' => [
                     ['id' => 'group-mic', 'name' => 'Expansion Mics', 'price' => 4000000, 'product_id' => \Modules\ProductCatalog\Models\Product::updateOrCreate(['slug' => 'logitech-group-mic-prod'], ['name' => 'Expansion Mics', 'price' => 4000000, 'description' => 'Expand the conversation area for Logitech Group', 'service_id' => $svcVC->id, 'brand_id' => $brandLogi->id])->id]
                ]
            ],
            'conditions' => ['brand' => 'logitech', 'roomType' => 'small_room']
        ]);
        $prodGroup = \Modules\ProductCatalog\Models\Product::updateOrCreate(
            ['slug' => 'group-prod'],
        ...
        $optRallyPlus = $qDevice->options()->create([
            ...
            'metadata' => [
                ...
                'accessories' => [
                     ['id' => 'rally-mic-pod-hub', 'name' => 'Mic Pod Hub', 'price' => 2500000, 'product_id' => \Modules\ProductCatalog\Models\Product::updateOrCreate(['slug' => 'rally-mic-hub-prod'], ['name' => 'Rally Mic Pod Hub', 'price' => 2500000, 'description' => 'Flexible microphone placement', 'service_id' => $svcVC->id, 'brand_id' => $brandLogi->id])->id],
                     ['id' => 'rally-speakermount', 'name' => 'Speaker Mount', 'price' => 500000, 'recommended' => true, 'product_id' => \Modules\ProductCatalog\Models\Product::updateOrCreate(['slug' => 'rally-speaker-mount-prod'], ['name' => 'Rally Speaker Mount', 'price' => 500000, 'description' => 'Secure mounting for Rally speakers', 'service_id' => $svcVC->id, 'brand_id' => $brandLogi->id])->id]
                ]
            ],
            'conditions' => ['brand' => 'logitech', 'roomType' => 'medium_room']
        ]);
        $prodRallyPlus = \Modules\ProductCatalog\Models\Product::updateOrCreate(
        ...
        $optGroupMedium = $qDevice->options()->create([
            ...
            'metadata' => [
                ...
                'description' => 'Affordable Video Conferencing',
                'accessories' => [
                     ['id' => 'group-mic', 'name' => 'Expansion Mics', 'price' => 4000000, 'product_id' => \Modules\ProductCatalog\Models\Product::where('slug', 'logitech-group-mic-prod')->first()->id]
                ]
            ],
            'conditions' => ['brand' => 'logitech', 'roomType' => 'medium_room']
        ]);
            ...
            'value' => 'rally-camera',
             'metadata' => [
                ...
                'description' => 'Premium PTZ Camera',
                 'accessories' => [
                     ['id' => 'rally-mount', 'name' => 'Camera Mount', 'price' => 500000, 'product_id' => \Modules\ProductCatalog\Models\Product::updateOrCreate(['slug' => 'rally-camera-mount-prod'], ['name' => 'Rally Camera Mount', 'price' => 500000, 'description' => 'Secure mounting for Rally Camera', 'service_id' => $svcVC->id, 'brand_id' => $brandLogi->id])->id]
                ]
            ],
            'conditions' => ['brand' => 'logitech', 'roomType' => 'medium_room']
        ]);
        $prodRallyCamera = \Modules\ProductCatalog\Models\Product::updateOrCreate(
        ...
        $prodMVC840 = \Modules\ProductCatalog\Models\Product::updateOrCreate(
            ['slug' => 'mvc840-prod'],
        ...
        $prodPanaCast = \Modules\ProductCatalog\Models\Product::where('slug', 'panacast-50-prod')->first();
        if ($prodPanaCast) {
        ...
        $prodASUS = \Modules\ProductCatalog\Models\Product::updateOrCreate(
        ...
        $prodLenovo = \Modules\ProductCatalog\Models\Product::updateOrCreate(
        ...
        $prodMicPod = \Modules\ProductCatalog\Models\Product::updateOrCreate(['slug' => 'mic-pod-prod'], ['name' => 'Expansion Mic Pod', 'price' => 3500000, 'description' => 'Extend audio coverage', 'service_id' => $svcVC->id, 'brand_id' => $brandLogi->id]);
        ...
        $prodMicHub = \Modules\ProductCatalog\Models\Product::updateOrCreate(['slug' => 'mic-pod-hub-prod'], ['name' => 'Mic Pod Hub', 'price' => 2500000, 'description' => 'Clean cable management', 'service_id' => $svcVC->id, 'brand_id' => $brandLogi->id]);
        ...
        $prodSpkBar = \Modules\ProductCatalog\Models\Product::updateOrCreate(['slug' => 'spk-bar-prod'], ['name' => 'External Speaker Bar', 'price' => 5000000, 'description' => 'Enhanced room audio', 'service_id' => $svcVC->id, 'brand_id' => $brandLogi->id]);
        ...
        $prodTap = \Modules\ProductCatalog\Models\Product::firstOrCreate(
            ['slug' => 'tap-usb-prod'],
        ...
        $prodTapTableMount = \Modules\ProductCatalog\Models\Product::firstOrCreate(
        ...
        $prodTapRiserMount = \Modules\ProductCatalog\Models\Product::firstOrCreate(
        ...
        $prodTapWallMount = \Modules\ProductCatalog\Models\Product::firstOrCreate(
        ...
        $prodTapIP = \Modules\ProductCatalog\Models\Product::firstOrCreate(
            ['slug' => 'tap-ip-prod'],
