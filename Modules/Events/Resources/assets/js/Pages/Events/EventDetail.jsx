...
export default function EventDetail({ event }) {
    ...
    const handleLogin = (e) => {
        e.preventDefault();
        loginForm.post(route("events.join", event.slug), {
            onSuccess: () => {
                                            ...
                                            {event.is_registered ? (
                                                ...
                                                "Pending" ? (
                                                    ...
                                                    [
                                                        ...
                                                        <div className="w-100">
                                                            <div className="alert alert-success d-flex align-items-center mb-0 text-center justify-content-center border-0 shadow-sm rounded-10">
                                                            ...
                                                            <Link
                                                                ...
                                                                className="th-btn th-radius th-icon w-100 style8 mt-3"
                                                            >
                                                                Lihat Tiket Anda{" "}
