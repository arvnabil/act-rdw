...
class ProjectController extends Controller
{
    public function index()
    {
        ...
        $filters = [
            ...
            'brands' => \Modules\ProductCatalog\Models\Brand::all(['id', 'name']),
            'solutions' => \Modules\Services\Models\ServiceSolution::all(['id', 'title']),
        ];
        ...
        $page = \Modules\CMS\Models\Page::where('slug', 'projects')->first();
