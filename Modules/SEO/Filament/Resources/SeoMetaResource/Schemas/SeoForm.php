...
namespace Modules\SEO\Filament\Resources\SeoMetaResource\Schemas;
                                ...
                                ->hintAction(
                                    Action::make('generate_json_ld')
                                        ...
                                        ->action(function (Get $get, Set $set, $record) {
                                            ...
                                            $seoService = app(\Modules\SEO\Services\Seo\SeoService::class);
                                            try {
                                                // Create a fresh manager for snapshot generation
                                                $seoManager = new \Modules\SEO\Services\Seo\SeoManager();
