...
namespace Modules\News\Filament\Resources\NewsResource\Schemas;
            ...
            Tabs::make('Tabs')
                ->tabs([
                                                ...
                                                ->schema([
                                                    ...
                                                    Select::make('categories')
                                                        ...
                                                        ->createOptionForm([
                                                            ...
                                                            TextInput::make('slug')
                                                                ->required()
                                                                ->unique(\Modules\News\Models\NewsCategory::class, 'slug', ignoreRecord: true),
                                                        ])
                                                        ->columnSpanFull(),
                                                    ...
                                                    Forms\Components\TagsInput::make('tags_input')
                                                        ...
                                                        ->afterStateHydrated(function (Forms\Components\TagsInput $component, ?\Modules\News\Models\News $record) {
                                                            $component->state($record ? $record->tags->pluck('name')->toArray() : []);
                                                        })
                                                        ->saveRelationshipsUsing(function (\Modules\News\Models\News $record, $state) {
                                                            $tagIds = collect($state)->map(function ($tagName) {
                                                                $tag = \Modules\News\Models\NewsTag::firstOrCreate(
                                                                    ['name' => $tagName],
                    ...
                    Tabs\Tab::make('Breadcrumb')
                        ->schema(\Modules\CMS\Filament\Schemas\BreadcrumbForm::schema('news')),
                ])->columnSpanFull()
        ];
    }
}
